...
const photos: GalleryPhoto[] = [
  ...
  {
    id: "hiraya-lounge",
    src: "/images/towerb/bedroom-two.jpg",
  ...
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/bedroom-three.jpg",
    title: "Another soft place to land",
    room: "Bedroom, alternate view",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/living-one.jpg",
    title: "Room to stretch out",
    room: "Living area, wide view",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/living-two.jpg",
    title: "A little corner to unwind",
    room: "Living area detail",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/living-three.jpg",
    title: "Natural light, all day",
    room: "Living area, daylight",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/kitchen-one.jpg",
  ...
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/kitchen-two.jpg",
    title: "Room to whip something up",
    room: "Kitchen detail",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/kitchen-three.jpg",
  ...
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/cr-one.jpg",
    title: "Fresh towels, fresh start",
    room: "Bathroom",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/cr-two.jpg",
    title: "A little steam, a little calm",
    room: "Bathroom detail",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/balcony-one.jpg",
    title: "Step outside for some air",
    room: "Private balcony",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  {
    id: "hiraya-kitchen",
    src: "/images/towerb/balcony-two.jpg",
    title: "Golden hour, right outside",
    room: "Balcony view",
    suite: "hiraya",
    alt: "A contemporary kitchen and dining area with warm neutral cabinetry",
  },
  ...
  {
    id: "mayumi-studio",
    src: "/images/tower4/bedroom-one.jpg",
    title: "Tucked in, just right",
    room: "Bedroom, alternate view",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/bedroom-two.jpg",
  ...
  {
    id: "mayumi-studio",
    src: "/images/tower4/bedroom-three.jpg",
    title: "A little corner all your own",
    room: "Cozy corner",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/bedroom-four.jpg",
    title: "Sunlight finds its way in",
    room: "Natural light",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/bedroom-five.jpg",
    title: "Small space, well spent",
    room: "Studio layout",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/bedroom-six.jpg",
    title: "A good book, a quiet nook",
    room: "Reading nook",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  ...
  {
    id: "mayumi-studio",
    src: "/images/tower4/living-one.jpg",
    title: "Room enough to relax",
    room: "Living space",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/living-two.jpg",
    title: "Settle in for the evening",
    room: "Lounge area",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/living-three.jpg",
    title: "One more episode, always",
    room: "TV & entertainment corner",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/living-four.jpg",
    title: "Small bites, big comfort",
    room: "Dining nook",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/kitchen-one.jpg",
    title: "A little kitchenette for little meals",
    room: "Kitchenette",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/kitchen-two.jpg",
    title: "Everything within reach",
    room: "Kitchenette detail",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/kitchen-three.jpg",
    title: "Coffee, tea, or both",
    room: "Compact counter",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  {
    id: "mayumi-studio",
    src: "/images/tower4/kitchen-four.jpg",
    title: "The little essentials, stocked",
    room: "Fridge & essentials",
    suite: "mayumi",
    alt: "Cozy open-plan studio apartment with warm wood, neutral tones, and sunlight",
  },
  ...
  },
  {
    ...
    title: "A cool dip, any weather",
    room: "Outdoor pool, Alternative view",
    suite: "shared",
    alt: "An outdoor swimming pool surrounded by tropical palm trees",
  },
  {
  ...
  },
  {
    ...
    title: "A little fun for the little ones",
    room: "Playground",
    suite: "shared",
    alt: "An outdoor swimming pool surrounded by tropical palm trees",
  },
  ...
  },
  {
    ...
    title: "A little green space to breathe",
    room: "Clubhouse garden",
    suite: "shared",
    alt: "An outdoor swimming pool surrounded by tropical palm trees",
  },
  {
...
const surprisePackages = [
  {
    ...
    items: [
      ...
      "10 floor balloons",
      "Fairy light accents",
      "Choice of balloon color combination",
    ],
  },
  {
    ...
    items: [
      ...
      "Fairy light accents",
      "Choice of balloon color combination",
      "Mini celebration cake or bottle of wine",
